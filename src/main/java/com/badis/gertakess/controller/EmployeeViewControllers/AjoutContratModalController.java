...
public class AjoutContratModalController {
    ...
    public void initialize() {
        employeComboBox.setItems(FXCollections.observableArrayList(EmployeDAO.getAllEmployesByFilters(null,null,null,null,"INACTIF",null)));
        ...
        posteComboBox.setValue(Utils.postes.get(0));

        typeComboBox.setItems(Utils.contrats);
        typeComboBox.setValue(Utils.contrats.get(0));
    }
